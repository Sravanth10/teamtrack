...
export const AdminDashboard = () => {
  ...
  const handleExportCSV = async () => {
    setExporting(true)
    try {
      // Query all tasks, joining creator's user profile and team details
      ...
      // Helper function to escape special characters for Excel (quotes, commas, newlines)
      const escapeCSV = (val) => {
                    ...
                    >
                      <div>
                        ...
                        {team.description ? (
                          ...
                          <p className="font-sans text-sm text-slate-600 italic mt-2">
